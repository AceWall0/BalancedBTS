...
class BalancedBSTSet:
    ...
    def rebalance(self, bstNode=None):
        ...
        if bstNode is None or bstNode == self.__root:
            ...
            self.__root = self.__distribute(subArray, None)
    ...
    #
    #  @param subtreeArray An array of Nodes generated by the subArray method.
    #  @param parent The parent where this sub tree is.
    def __distribute(self, subtreeArray, parent):
        if len(subtreeArray) == 0:
            return None
